...
import com.rokid.cxrmsamples.repository.Stage3ClsModelCatalog
...
class ModelConfigurationTest {
    ...
    fun defaultPipelineUsesXnnpackInt8Models() {
        ...
        val stage3 = requireNotNull(Stage3ClsModelCatalog.findById(Stage3ClsModelCatalog.defaultId))
        val defaults = listOf(
            stage1.useXnnpack to stage1.assetFileName,
            stage2.useXnnpack to stage2.assetFileName,
            stage3.useXnnpack to stage3.assetFileName
        )
    ...
    fun legacyTimingInformationIsPresentedInEnglish() {
        ...
        assertEquals(
            "Inference total=5038ms; Stage 1 coarse segmentation=2065ms; Stage 2 fine segmentation=1674ms; Stage 3 disease classification=226ms; Generate name=17ms; Inference total=5036ms",
